#![allow(dead_code)]
use crate::{components::{dm::DarkModeToggle, patchnote::PatchNote, win::Win}, pages::home::HomeProps};
use sycamore::{prelude::*, web::portal::Portal};


const DIV: &str = "sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 bg-transparent lg:z-50 lg:border-b lg:border-zinc-900/10 dark:border-zinc-50/[0.06] bg-[#fafafa]/95 supports-backdrop-blur:bg-[#fafafa]/60 dark:bg-transparent";
...
#[component]
pub fn HeaderContent<G: Html>(props: HomeProps<G>) -> View<G> {
...
#[component]
pub fn Header<G: Html>(props: HomeProps<G>) -> View<G> {
    let on_click = props.on_click;
    view! {

            // Always render the header content
            HeaderContent(on_click=on_click)
