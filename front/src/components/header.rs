...
use crate::components::dm::DarkModeToggle;

const DIV: &str = "sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-zinc-900/10 dark:border-zinc-50/[0.06] bg-white/95 supports-backdrop-blur:bg-white/60 dark:bg-transparent";
                        ...
                        div(class="relative hidden lg:flex items-center ml-auto") {
                            nav(class="text-sm leading-6 font-semibold text-zinc-700 dark:text-zinc-200") {
                                ul(class="flex space-x-8") {
                                    li(class="hover:text-blue-500 dark:hover:text-blue-400") {
                                        a(href="static/patchnote.md", target="_blank") {
                                            "What's new?"
                                        }
                                    }
                                }
                            ...
                            div(class="flex items-center border-l border-orange-500 ml-6 pl-6 dark:border-orange-800") {
                                ...
                                a(class="ml-6 block text-zinc-400 hover:text-zinc-500 dark:hover:text-zinc-300", target="_blank", rel="noopener noreferrer", href="https://github.com/belesspathetic") {
                                    svg(class="hover:fill-[#c9510c] transition colors", viewBox="0 0 16 16", aria-hidden="true", height="30px", width="30px",) {
                                        path(d=GITHUB)
                                    }
                                }
                            }
